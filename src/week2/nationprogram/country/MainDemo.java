...
public class MainDemo {
    ...
    public static void main(String[] args) {
        ...
        southkorea.travelAgency.travel_approval(Korean1, southkorea);
        northkorea.travelAgency.travel_approval(Japanese1, northkorea);
        southkorea.travelAgency.travel_approval(Russian1, southkorea);
        northkorea.travelAgency.travel_approval(North_Korean1, northkorea);
        russia.travelAgency.travel_approval(Russian1, russia);
        russia.travelAgency.travel_approval(North_Korean1, russia);
